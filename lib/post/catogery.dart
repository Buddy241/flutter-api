...
class ncatogery extends StatefulWidget {
  const ncatogery({super.key});

  @override
  State<ncatogery> createState() => _ncatogeryState();
}

class _ncatogeryState extends State<ncatogery> {
  ...
  Future<void> fetchData2() async {
    ...
    final url = Uri.parse('http://92.205.109.210:8028/category/create');
